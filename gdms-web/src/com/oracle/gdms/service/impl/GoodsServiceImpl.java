...
public class GoodsServiceImpl extends BaseService implements GoodsService {
	...
	private ResponseEntity push(String jsonstr) {
		...
		//String url = "http://cubog33967.java.cdnjsp.org/gdms-web/rest/huazhao/push/goods/one";
		//String url = "http://qveqn72442.java.cdnjsp.org/gdms-web/rest/huazhao/push/goods/one";
	...
	@Override
	public int delthis(int goodsid) {
		// TODO 删除单项商品
		try {
			session = GDMSUtil.getSession();
			GoodsDao dao = session.getMapper(GoodsDao.class);
			dao.delthis(goodsid);//执行更新
			session.commit();
			return 1;
		} catch (Exception e) {
			e.printStackTrace();
